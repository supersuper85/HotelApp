...
namespace HotelApp.Data.Migrations
{
    ...
    [Migration("20220715112606_AddedUniquConstraint")]
    partial class AddedUniquConstraint
    {
            ...
            modelBuilder.Entity("HotelApp.Data.Entities.Customer", b =>
                {
                    ...
                    b.HasIndex("ApartmentId", "HotelId", "CNP")
                        .IsUnique();
            ...
            modelBuilder.Entity("HotelApp.Data.Entities.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApartmentId = 2,
                            HotelId = 1,
                            RegistrationDate = new DateTime(2022, 7, 15, 11, 26, 6, 129, DateTimeKind.Utc).AddTicks(126),
                            ReleaseDate = new DateTime(2022, 7, 16, 11, 26, 6, 129, DateTimeKind.Utc).AddTicks(129)
                        });
                });
